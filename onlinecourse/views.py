...
def submit(request, course_id):
    ...
    # Use the extract_answers method to get a list of selected choice IDs
    choices_ids = extract_answers(request)
    
    # Retrieve the actual Choice objects using the IDs
...
def show_exam_result(request, course_id, submission_id):
    ...
    for question in questions:
        ...
        # Check if the selected choices are the exact same as the correct choices
